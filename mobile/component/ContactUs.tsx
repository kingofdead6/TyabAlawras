    ...
    >
      <View style={{ marginBottom: 30, alignItems: "center" }}>
        ...
        >
          ...
          <Text style={{ color: "#FFF", marginLeft: 10 }}>info@tyabalawras.com</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={{ flexDirection: "row", alignItems: "center", marginBottom: 10 }}
          onPress={() => openLink("tel:0654768883")}
        >
          <MaterialIcons name="phone" size={20} color="#FACC15" />
          <Text style={{ color: "#FFF", marginLeft: 10 }}>0654768883</Text>
        </TouchableOpacity>
      ...
      >
        <View style={{
          ...
          <View style={{ backgroundColor: "#111", borderRadius: 10, padding: 20, maxHeight: "80%" }}>
            <ScrollView>
              <Text style={{ color: "#FACC15", fontSize: 24, fontWeight: "bold", marginBottom: 10, textAlign: "center" }}>
                سياسة الخصوصية
              </Text>
              ...
              <Pressable
                style={{ marginTop: 20, alignSelf: "center", padding: 10, backgroundColor: "#FACC15", borderRadius: 5 }}
